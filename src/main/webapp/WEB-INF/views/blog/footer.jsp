			...
			<div width="100%">
				<table>
					<tr>
						...
						<font size="1">생활<br>노하우<br>쇼핑</font>
						</td>
						<td width="10%">
						<font size="2">
						<ul>
						...
						<ul>	
							...
							<li><a href="/sub/PostListByDirectory.nhn?option.directorySeq=36" name="directoryItem">원예·재배</a></li>
						</ul>	
						</font>
						</td>
						<td width="5%" align="center">
						<font size="1">취미<br>여가<br>여행</font>
						</td>
						<td width="10%">
						<font size="2">
						<ul>
